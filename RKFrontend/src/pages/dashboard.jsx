        ...
        <>
                ...
                <nav className="top-app-bar navbar navbar-expand navbar-dark bg-dark">
                    <div className="container-fluid px-4">
                        ...
                        <button className="btn btn-lg btn-icon order-1 order-lg-0" id="drawerToggle" href="javascript:void(0);"><i className="material-icons">menu</i></button>
                            ...
                            <div className="d-flex">
                                ...
                                <div className="dropdown">
                                    ...
                                    <ul className="dropdown-menu dropdown-menu-end mt-3" aria-labelledby="dropdownMenuProfile">
                                        ...
                                        <li>
                                            <a className="dropdown-item" href="app-auth-login-styled-1.html">
                            ...
                            <div className="drawer-menu">
                                <div className="nav">
                                    ...
                                    <a className="nav-link d-sm-none" href="#!">
                                        <div className="nav-link-icon"><i className="material-icons">notifications</i></div>
                                        Notifications
                                    </a>

                                    <a className="nav-link d-sm-none" href="#!">
                                        <div className="nav-link-icon"><i className="material-icons">mail</i></div>
                                        Messages
                                    </a>
                                            ...
                                            <div className="card card-raised h-100">
                                                ...
                                                <div className="card-body p-4">
                                                    <div className="d-flex h-100 w-100 align-items-center justify-content-center">
                                                        <div className="w-100" style={{ maxWidth: '20 rem' }}><canvas id="myPieChart"></canvas></div>
                                                    </div>
                                                </div>
                                                <div className="card-footer bg-transparent position-relative ripple-gray">
                                                    <a className="d-flex align-items-center justify-content-end text-decoration-none stretched-link text-primary" href="#!">
                                            ...
                                            <div className="card card-raised h-100">
                                                <div className="card-body p-4">
                                                    <div className="d-flex justify-content-between">
                                                        ...
                                                        <img src="assets/img/illustrations/security.svg" alt="..." style={{ height: '9rem' }} />
                                                    </div>
                                                </div>
                                                ...
                                                <div className="card-body p-4">
                                                    <div className="d-flex justify-content-between">
                                                        <div className="me-4">
                                                            ...
                                                            <div className="progress mb-2" style={{ height: '0.25rem' }}><div className="progress-bar" role="progressbar" style={{ width: '33%' }} aria-valuenow="10" aria-valuemin="0" aria-valuemax="30"></div></div>
                        ...
                        <footer className="py-4 mt-auto border-top" style={{ minHeight: '74px' }}>
                            <div className="container-xl px-5">
                                <div className="d-flex flex-column flex-sm-row align-items-center justify-content-sm-between small">
                                    <div className="me-sm-2">Copyright &copy; Your Website 2023</div>
